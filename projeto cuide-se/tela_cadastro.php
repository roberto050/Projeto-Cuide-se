        ...
        <div class="form-box">
            ...
            <form action="#" method="post">
                ...
                <div class="input-group w50">
                    ...
                    <input type="email" id="email coorporativo" placeholder="Digite o seu email" required>
                </div>
                ...
                <div class="input-group w50">
                    ...
                    <input type="number" id="CNPJ" placeholder="Digite o seu CNPJ" required>
                </div>
                ...
                <div class="input-group w50">
                    ...
                    <input type="number" id="cep" placeholder="Digite o cep" required>
                </div>
                ...
                <div class="input-group w50">
                    ...
                    <input type="text" id="Bairro" placeholder="Digite o bairro" required>
                </div>
